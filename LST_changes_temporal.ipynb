...
day_file_pattern = f'/home/bohuang/Work/Code/Biomass/data/LST_Diff/{lstDay_variable}_{patch}cell_{forest}_*.csv'
night_file_pattern = f'/home/bohuang/Work/Code/Biomass/data/LST_Diff/{lstNight_variable}_{patch}cell_{forest}_*.csv'
